...
|---|---|---|---|
| Victor Vorski | Camp Audax / Q1 connector | Active | Answer 20% allocation question before Brad outreach |
| Brad Nye | Media partnership (via Victor) | Pending Victor | Christine to send brief ack email |
| Murdoch | Potential community member | Outreach in progress | Christine to DM on Discord |
| Brandon | Potential community member | Outreach in progress | Group call week of July 21 |
| Zach (Frogakuda) | Potential AI engineer/member | 1:1 scheduled | Ed to DM on Signal |
| Neil | Supporter only | No active contract | No further asks until contract |
| Henry (PandaBlocks) | Consortium partner candidate | Exploring | Ed drafted Tetsu/Henry one-pager |
| Christine | Co-lead | Active | Design iteration + stakeholder outreach |
...
| 2026-07-14 | Community model + membership | `Memory/STE - 2026-07-14 - Community Model and Membership.md` |
| 2026-07-14 | Website copy strategy | `Memory/STE - 2026-07-14 - Website Copy Strategy.md` |
| 2026-07-14 | Website design direction | `Memory/STE - 2026-07-14 - Website Design Direction.md` |
| 2026-07-14 | IP tracking + tooling | `Memory/STE - 2026-07-14 - IP Tracking and Tooling.md` |
